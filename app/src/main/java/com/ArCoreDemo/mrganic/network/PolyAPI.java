...
public class PolyAPI {
     ...
     */
    public void GetAsset(String assetId, Handler handler, CompletionListener completionListener) {
    ...
    public void ListAssets(String keywords, boolean curatedOnly, String category, Handler handler, CompletionListener completionListener) {
